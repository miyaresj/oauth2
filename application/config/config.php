...
define('OAUTH_HOST', '192.168.10.70');
define('OAUTH_NAME', 'lbc3');
define('OAUTH_USER', 'botcat');
define('OAUTH_PASS', 'r5uJg71Dd0lH1CJ');

define('TW_HOST', '192.168.10.70');
define('TW_NAME', 'Twitch');
define('TW_USER', 'botcat');
define('TW_PASS', 'r5uJg71Dd0lH1CJ');
